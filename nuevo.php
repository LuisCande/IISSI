    ...
    <nav class="acceder">
      ...
      <form method="get" action="consulta_carrito.php">
        ...
        <input type="submit" value="Cambiar">
		   ...
		   <ul>
		      <li>
		         ...
		         <div id="login-content">
		            <form>
                  <input id="fechaEntrega" name="fechaEntrega" type="date" value="<?php echo $carrito['fechaEntrega'];?>" required/>
          ...
          <label>
            <input name="Tarjeta" type="radio" value="True" <?php if($carrito['TIPOPAGO']=='Tarjeta') echo ' checked ';?>/>
            Tarjeta</label>
          <label>
            <input name="Transferencia" type="radio" value="False" <?php if($carrito['TIPOPAGO']=='Transferencia') echo ' checked ';?>/>
            Transferencia</label>
          </div>
    <div><label>Estado:</label>
    <label>
      <input name="estado" type="radio" value="Espera" <?php if($carrito['ESTADO']=='Espera') echo ' checked ';?>/>
      Espera</label>
      <label>
        <input name="estado" type="radio" value="Transito" <?php if($carrito['ESTADO']=='Transito') echo ' checked ';?>/>
        Transito</label>
        <label>
          <input name="estado" type="radio" value="Entregado" <?php if($carrito['ESTADO']=='Entregado') echo ' checked ';?>/>
          Entregado</label>
    </div>
