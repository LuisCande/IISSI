	 ...
	 <nav id="navig">
		...
		<div id="enlaces">
			...
			<?php }	else { ?>
						...
						<a href="consulta_motor.php?PAG_NUM=<?php echo $pagina; ?>&PAG_TAM=<?php echo $pag_tam; ?>"><?php echo $pagina; ?></a>
		...
		<form method="get" action="consulta_motor.php">
...
<?php 	if(comprobar_tipo_usuario($conexion,$_SESSION['login'])!='Cliente'){?>
	<p id="registrar"><a href="form_alta_motor.php">
...
<?php	$auxOferta 	=str_replace(',', '', $fila["OFERTA"]);?>
						Oferta: <input id="oferta" name="oferta" pattern="^\d{0,2}" title="Por favor introduzca un número válido" type="text" value="<?php echo $auxOferta; ?>"/>%
<br><br>
...
<br><br>
				...
				<?php }	else { ?>
						...
						<div class="codigo">Código: <em><?php echo $fila["CODIGO"]; ?></em></div>
...
<?php }?>
						...
						<?php }?>
						<div class="cilindrada">Cilindrada: <em><?php echo $fila["CILINDRADA"]; ?></em></div>

						<div class="estado">Estado: <em><?php echo $fila["ESTADO"]; ?></em></div>

						<div class="ANYOFABRICACION">Año de fabricación: <em><?php echo $fila["ANYOFABRICACION"]; ?></em></div>

						<div class="garantia">Garantía: <em><?php echo $fila["GARANTIA"]; ?></em> año/s</div>
